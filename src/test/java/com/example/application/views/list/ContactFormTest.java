...
public class ContactFormTest {
    ...
    public void saveEventHasCorrectValues(){
        ...
        AtomicReference<Contact> savedConctact = new AtomicReference<>(null);
        form.addListener(ContactForm.SaveEvent.class, e -> savedConctact.set(e.getContact()));

        form.save.click();

        Contact saved = savedConctact.get();
